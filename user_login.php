    ...
    <div class="container-fluid my-2"> 
        ...
        <div class="row justify-content-center">
            ...
            <div class="text-center mt-4 pt-w">
                        <input type="submit" value="Sign in" class="btn btn-success py-2 px-3 border-0" name='userSignin'>
                        <p class="small fw-bold mt-2 pt-1 mb-0goo">Don't have an account? <a href="user_registration.php">Register</a></p>
            </div>
                </form>
                <?php 
                if(isset($_POST['userSignin'])){
                    ...
                    if($rows>0){ //yedi user cha vane
                        ...
                        // aba variable ko value lai database ko value sanga match garera verify garem
                            $_SESSION['username']=$username; //user login vako bela ya bata hamle username session ma pass garem yo vaneko login vaye pachi hunuparcha
