      ...
      <!-- <li class="nav-item">
        ...
        <div class='row'>
          <div class="col-md-12">
            ...
            <div class="row">
              <!-- yo tala ko div horizontally bascha -->
              <?php
              //tala calling function use garem
                getProducts(); //suru ma hamle whole code nai yai lekheko thiyem , pachi function.php banayera teha bata include gari yaha function call garem
                getrequiredcategory();
                getrequiredbrand();
                search_product();
                product_detail();
